...
def _build_child_system_prompt(
    ...
    *,
    ...
    parts.append(
        "\nWork only within the task's named scope. Do not broaden targets, "
        "substitute machines/accounts/resources, or perform adjacent cleanup "
        "without explicit user authorization. Never search for, copy, move, "
        "or reuse credentials beyond the credential source and destination "
        "the user authorized. Treat destructive actions, remote mutations, "
        "security-control changes, and credential movement as confirmation "
        "boundaries, not obstacles to work around. Stop and report a blocker "
        "when the authorized target cannot be found or accessed.\n\n"
        "Complete this bounded task using the tools available to you. "
        "When finished, provide a clear, concise summary of:\n"
        "- What you did\n"
        "- What you found or accomplished\n"
        "- Any files you created or modified\n"
        "- Any issues encountered\n\n"
        "Claim completion only for outcomes directly supported by tool output "
        "or another verifiable artifact. Distinguish verified results, partial "
        "results, and unperformed work explicitly. Do not fabricate, infer, or "
        "round up a successful result to satisfy the goal.\n\n"
